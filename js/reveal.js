...
(function(root, factory) {
  ...
  function syncBackground(slide) {
    ...
    if (slide.hasAttribute("data-preload"))
  ...
  function configure(options) {
    ...
    if (config.navigationMode === "linear") {
      keyboardShortcuts["&#8594;  ,  &#8595;  ,  SPACE  ,  N  ,  L  ,  J"] =
        "Next slide";
      keyboardShortcuts["&#8592;  ,  &#8593;  ,  P  ,  H  ,  K"] =
        "Previous slide";
    } else {
  ...
  function locationHash(slide) {
    ...
    // Otherwise use the /h/v index
      ...
      if (index.h > 0 || index.v > 0 || index.f !== undefined)
        url += index.h + hashIndexBase;
      if (index.v > 0 || index.f !== undefined)
      ...
      for (var i = 0; i < slidesLength; i++) {
        ...
        if (i < index) {
          ...
          if (config.fragments) {
            ...
            toArray(element.querySelectorAll(".fragment")).forEach(function(
              fragment
            ) {
              fragment.classList.add("visible");
              fragment.classList.remove("current-fragment");
          ...
          if (config.fragments) {
            ...
            toArray(element.querySelectorAll(".fragment.visible")).forEach(
              function(fragment) {
  ...
  function loadSlide(slide, options) {
    ...
    if (background) {
      ...
      var backgroundIframeElement = backgroundContent.querySelector(
        "iframe[data-src]"
      );
      if (backgroundIframeElement) {
        // Check if this iframe is eligible to be preloaded
        if (
          shouldPreload(background) &&
  ...
  function unloadSlide(slide) {
    ...
    if (background) {
      ...
      toArray(background.querySelectorAll("iframe[src]")).forEach(function(
        element
      ) {
  ...
  function updateFragments(index, fragments) {
    ...
    if (currentSlide && config.fragments) {
      fragments =
        fragments || sortFragments(currentSlide.querySelectorAll(".fragment"));
